...
$result = mysqli_query($conn,"SELECT * FROM materi WHERE pertemuan = '$pertemuan' ");
        ...
        <div style="height: 100vh;" class="row">
            ...
            <div class="col-10 p-4 px-5">
                ...
                <tr>
                        ...
                        <td><input type="text" name="pertemuan" id="pertemuan" value="<?= $row["pertemuan"] ?>"></td>
                        <td rowspan="5"><img src="src/amikom.svg" width="160" alt=""></td>
                    </tr>
                    <tr>
                        <td><label for="judul">Judul</label></td>
                        <td><input type="text" name="judul" id="judul" value="<?= $row["judul"] ?>"></td>
                    </tr>
                    <tr>
                        <td><label for="deskripsi">Deskripsi</label></td>
                        <td><textarea name="deskripsi" id="deskripsi" rows="3"><?= $row["deskripsi"] ?></textarea></td>
                    </tr>
    
                </tbody>
                </table>

                <button type="submit" name="edit_materi" class="mx-auto mt-4 rounded-4 py-1 px-3 btn btn amikom-btn">
                    Simpan
                </button>
                <a href="list_materi.php?username=<?= $username ?>" type="submit" name="cancel" class="mx-auto mt-4 rounded-4 py-1 px-3 btn btn amikom-btn">
                    Cancel
                </a>
