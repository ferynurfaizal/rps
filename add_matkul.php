    ...
    <div class="container-fluid">
        <div style="height: 100vh;" class="row">
            ...
            <div class="col-10 p-4 px-5">
                ...
                <h5 class="my-3">Form Tambah Mata Kuliah</h5>

                <form action="" method="post">
                <table class="table table-borderless w-75">
                <tbody>
                    <tr>
                        <td style="width: 15%;"><label for="code">Code</label></td>
                        <td style="width: 45%;"><input type="text" name="code" id="code" placeholder="" required></td>
                        <td rowspan="5"><img src="src/amikom.svg" width="160" alt=""></td>
                    </tr>
                    <tr>
                        <td><label for="matkul">Mata Kuliah</label></td>
                        <td><input type="text" name="matkul" id="matkul" placeholder="" required></td>
                    </tr>
                    <tr>
                        <td><label for="nm_dos">Nama Dosen</label></td>
                        <td><input type="text" name="nm_dos" id="nm_dos" placeholder="" required></td>
                    </tr>
                    <tr>
                ...
                <button type="submit" name="add_matkul" class="mx-auto mt-4 rounded-4 py-1 px-3 btn btn amikom-btn">
                    Tambah
                </button>
                <a href="list_matkul.php?username=<?= $username ?>" name="cancel" class="mx-auto mt-4 rounded-4 py-1 px-3 btn btn amikom-btn">
                    Cancel
                </a>
